...
public class CommonAPI1 {
    ...
    private String saucelabs_username = "renxing18";
    private String browserstack_username = "renxingxing1";
    private String saucelabs_accesskey = "50475992-7e57-4322-b487-3a3ced6282d3";
    private String browserstack_accesskey = "DyE5Dpu9u1W4WLaQT9yn";

    @Parameters({"useCloudEnv", "cloudEnvName", "os", "os_version", "browserName", "browserVersion", "url"})
    @BeforeMethod
    public void setUp(@java.util.Optional("false") boolean useCloudEnv, @java.util.Optional("false") String cloudEnvName,
                      @java.util.Optional("windows") String os, @java.util.Optional("10") String os_version, @java.util.Optional("firefox") String browserName, @java.util.Optional("34")
...
/* path example to upload a file/image
    ...
    public List<String> getAssertData(String DataFilePath, int ColumnNo) throws IOException {
        DataReader1 dtr = new DataReader1();
